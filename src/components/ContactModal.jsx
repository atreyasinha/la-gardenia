            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  {/* SECURITY: Limit input length to prevent client-side resource exhaustion/large payload injection */}
                  <input
                    id="name"
                    type="text"
                    required
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  {/* SECURITY: Validate phone pattern and limit length to prevent injection and resource exhaustion */}
                  <input
                    id="phone"
                    type="tel"
                    required
              ...
              <div>
                ...
                {/* SECURITY: Limit length of unstructured text input to prevent payload injection size issues */}
                <textarea
                  id="notes"
                  rows="3"
                  maxLength={500}
