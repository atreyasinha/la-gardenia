            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <input
                    ...
                    type="text"
                    required
                    maxLength={100} // SECURITY: Limit input length to prevent potential client-side DoS or URL length overflow
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <input
                    ...
                    type="tel"
                    required
                    maxLength={20} // SECURITY: Restrict phone number length
              ...
              <div>
                ...
                <textarea
                  id="notes"
                  rows="3"
                  maxLength={1000} // SECURITY: Cap the length of notes to prevent massive payload creation in memory
